    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form action="{{route('product.update',$product->id)}}" class="product_form" id="product_form" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="product_price" value="{{ $product->product_price }}" placeholder="Enter category name" class="form-control" required>
                </div>
              </div>
              <div class="form-group row">
    ...
    @endforeach
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9 customer_choice_options" id="customer_choice_options">
                    ...
                    @include('admin.mpartials.choices',['choice_no'=>$product->attributes,'choice_options'=>$product->choice_options])
                </div>
              </div>


              <div class="pt-4 col-12 sku_combination" id="sku_combination">
                @include('admin.mpartials.edit_combination',['combinations'=>json_decode($product['variation'],true)])
              </div>
